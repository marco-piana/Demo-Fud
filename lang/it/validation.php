...
return array (
  ...
  'active_url' => 'URL :attribute non valida.',
  'after' => ':attribute deve essere una data successiva a :date.',
  'after_or_equal' => ':attribute deve essere una data uguale o precedente a :date.',
  ...
  array (
    'address_id' => 
    array (
      'required' => 'Per favore seleziona il tuo indirizzo',
    ),
    'dinein_table_id' => 
    array (
    ...
    array (
      'required' => 'Il tentativo di pagamento non è riuscito. Se sei un amministratore di sistema, verifica il problema nel fornitore di servizi di pagamento.',
    ),
    ...
    'order_price' => 
    array (
      'min' => 'Ordine minimo :min. Per favore aggiungi altri prodotti al carrello.',
    ),
    'paypal_payment_approval_missing' => 
    array (
      'required' => 'Non siamo riusciti a ottenere il link per il pagamento PayPal.',
    ),
    'paypal_payment_error_action' => 
    array (
      'required' => 'Il tentativo di pagamento non è riuscito perché sono necessarie ulteriori azioni prima che possa essere completato',
    ),
    ...
    array (
      'required' => 'Il tentativo di pagamento non è riuscito per vari altri motivi, ad esempio per esaurimento dei fondi disponibili. Si prega di verificare i dati forniti.',
    ),
  ),
