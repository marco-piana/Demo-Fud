    ...
    @else
        <div class="col-md-6">
            @include('partials.input', [
                ...
                'required' => false,
                'additionalInfo' => '0 is unlimited numbers of drivers',
                'value' => isset($plan) ? $plan->limit_items : null,
            ])
        </div>
    @endif
...
<div class="row">
    ...
    @if (!config('settings.makePureSaaS', false) && !(config('app.isdrive', false) || config('app.issd', false)))
        ...
        <div class="col-md-6 mt-3">
            ...
            <label class="form-control-label">{{ __('Order services') }}</label>
            @include('partials.fields', [
                'fields' => [
                    [
                        ...
                        'name' => 'Pickup',
                        'id' => 'can_pickup',
                        'value' => isset($plan) ? ($plan->can_pickup == 1 ? 'true' : 'false') : null,
                    ],
                    [
                        'ftype' => 'bool',
                        'name' => 'Delivery',
                        'id' => 'can_deliver',
                        'value' => isset($plan) ? ($plan->can_deliver == 1 ? 'true' : 'false') : null,
                    ],
                    [
                        'ftype' => 'bool',
                        'name' => 'Free Delivery',
                        'id' => 'free_deliver',
                        'value' => isset($plan) ? ($plan->free_deliver == 1 ? 'true' : 'false') : null,
                    ],
                ],
            ])
            @include('partials.fields', [
                'fields' => [
                    [
                        ...
                        'name' => 'Order Table',
                        'id' => 'order_table',
                        'value' => isset($plan) ? ($plan->order_table == 1 ? 'true' : 'false') : null,
                    ],
                    [
                        'ftype' => 'bool',
                        'name' => 'Table Reservation',
                        'id' => 'table_reservation',
                        'value' => isset($plan) ? ($plan->table_reservation == 1 ? 'true' : 'false') : null,
                    ],
                ],
            ])
