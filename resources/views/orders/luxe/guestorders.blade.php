            ...
            <div class="col-12">
                ...
                <div class="card relative bg-secondary p-5">
                    <div class="card-header border-bottom d-flex flex-column w-100 bg-white mb-4">
                        ...
                        <div class="order-item-date mb-3 d-flex"><svg width="14" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g stroke-linecap="round" stroke-width="2" stroke="currentColor" fill="none" stroke-linejoin="round"><path d="M16 2a14 14 0 1 0 0 28 14 14 0 1 0 0-28Z"/><path d="M16 8v8l4 4"/></g></svg><small>&nbsp;{{ __('Updated at') }}&nbsp;{{ $stakeholder->pivot->created_at->locale(Config::get('app.locale'))->isoFormat('LT') }}</small></div>
                    </div>
                    <div class="row">
                        <div class="col-12">
