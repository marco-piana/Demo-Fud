        ...
        <div class="nav-wrapper">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                ...
                @if(auth()->user()->hasRole('admin'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-menagment-main" data-toggle="tab" href="#qrtemplate" role="tab" aria-controls="tabs-menagment" aria-selected="true"><i class="ni ni-mobile-button mr-2"></i>{{ __('QR Template')}}</a>
                    </li>
                @endif
            </ul>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="tab-content" id="tabs">
                ...
                @if(auth()->user()->hasRole('admin'))
                    ...
                    <div class="tab-pane fade show" id="qrtemplate" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                        @include('restorants.partials.qrtemplate')
                    </div>
                @endif
