    ...
    <div class="modal-dialog modal modal-dialog-centered " role="document" id="modalDialogItem">
        <div class="modal-content">
            ...
            <div class="modal-body p-4" id="new_address_checkout_body">
                <form role="form">
                    @csrf
                    <div class="form-group{{ $errors->has('new_address') ? ' has-danger' : '' }}" id="new_address_checkout_holder">
                        <label class="form-control-label" for="new_address_checkout">{{ __('Address') }}</label>
                        <select class=" form-control" id="new_address_checkout" placeholder="{{ __('Start typing your address')}}">
                        </select>
                    </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col"><button id="submitNewAddress" type="button" class="btn w-100 d-flex justify-content-center align-items-center rounded-sm btn-outline-primary text-sm">{{ __('Save') }}</button></div>
                    </div>
                </form>
            </div>            
        </div>
