...
use App\Http\Controllers\UserViewerController;
...
Route::get('/' . config('settings.url_route') . '/{alias}', [FrontEndController::class, 'restorant'])->middleware('checkForceLogin')->name('vendor');
...
// Brij Negi Update
Route::prefix('userviewer')->group(function () {
    Route::post('/register', [UserViewerController::class, 'register'])->name('userviewer.register');
    Route::post('/login', [UserViewerController::class, 'login'])->name('userviewer.login');
    Route::post('/logout', [UserViewerController::class, 'logout'])->name('userviewer.logout');
    Route::post('/forgot-password', [UserViewerController::class, 'forgotPassword'])->name('userviewer.forgot-password');
    Route::post('/resend-verification', [UserViewerController::class, 'resendVerification'])->name('userviewer.resend-verification');
    Route::get('/reset-password/{token}', [UserViewerController::class, 'showResetPasswordForm'])->name('userviewer.reset-password.form');
    Route::post('/reset-newpassword', [UserViewerController::class, 'resetPassword'])->name('userviewer.reset-newpassword');
});
...
Route::middleware('auth', 'impersonate')->group(function () {
    ...
    Route::get('/qrtemplate/images', [QRTemplateController::class, 'fetch'])->name('qrtemplate.image.fetch');
    Route::post('/qrtemplate/images', [QRTemplateController::class, 'upload'])->name('qrtemplate.image.upload');
    Route::delete('/qrtemplate/images', [QRTemplateController::class, 'delete'])->name('qrtemplate.image.delete');
    Route::post('/qrtemplate/{restaurant_id}', [QRTemplateController::class, 'zipImages']);
