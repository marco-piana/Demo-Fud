...
class Cart extends React.Component {
  ...
  renderProceedButton(){
    if(this.state.loggedIn){
      return (<Button style={{backgroundColor:materialTheme.COLORS.DEFAULT, width:"100%"}} onPress={()=>{this.props.navigation.navigate('SelectAddress',{"restaurant_id":this.state.order[0].restaurant_id})}} shadowless >{Language.proceedToCheckout.toUpperCase()}</Button>)
    }else{
