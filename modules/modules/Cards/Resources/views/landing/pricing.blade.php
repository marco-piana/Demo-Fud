       ...
       @foreach ($plans as $plan )
           ...
           <div class="w-full md:w-1/2">
            <div class="relative w-full p-10 overflow-hidden bg-gray-900 shadow-xl lg:rounded-lg" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                ...
                <a href="{{ route('newrestaurant.register')}}" class="relative block w-full py-4 overflow-hidden text-base font-semibold text-center text-gray-800 bg-white rounded-lg" data-rounded="rounded-lg">
